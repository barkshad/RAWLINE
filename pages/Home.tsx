...
const Home: React.FC = () => {
  ...
  return (
    <main className="min-h-screen pt-32 md:pt-48 bg-bone">
      <section className="px-6 md:px-12 max-w-6xl">
        ...
        >
          ...
          <motion.p 
            variants={FADE_UP}
            className="text-xl md:text-3xl font-light leading-relaxed max-w-3xl opacity-40 font-sans"
          >
          ...
          <motion.div variants={FADE_UP} className="pt-12">
            <Link to="/shop" className="group flex items-center space-x-12 w-fit">
              <span className="text-xs uppercase tracking-[0.5em] font-bold py-2 relative overflow-hidden">
                Archive Selection
      ...
      <section className="mt-48 px-6 md:px-12 pb-32">
        <RevealOnScroll delay={0.4}>
          <div className="relative aspect-[16/9] md:aspect-[21/9] overflow-hidden bg-charcoal/5 group shadow-[0_40px_100px_-20px_rgba(0,0,0,0.12)] rounded-sm">
            <motion.img 
              whileHover={{ scale: 1.03 }}
              transition={{ duration: 2, ease: [0.19, 1, 0.22, 1] }}
              src={getCloudinaryUrl(content.home.heroImageId, { width: 2400 })} 
              className="w-full h-full object-cover filter grayscale hover:grayscale-0 transition-all duration-[2000ms]"
